...
![Word cloud der häufigsten Werkzeuge in den Digital Humanities](../assets/images/wordcloud/wordcloud-rel-100_tools-in-1036-dh-conferences-2014-2018-w_100.svg)

::::
:::: column

![Netzwerkanalyse mit R und Gephi](../assets/images/network_oape-p3a6afa20_authors_unimodal-n-size_out-degree_ar.png)

![Digitale Editionen in TEI XML](../assets/images/sublime_zuhur.png)
